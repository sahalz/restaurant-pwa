...
export const supportAPI = {
  ...
  escalateSupportTicket: (id) => api.patch(`/support/${id}/escalate`),
  resolveSupportTicket: (id) => api.patch(`/support/${id}/resolve`),
  closeSupportTicket: (id) => api.patch(`/support/${id}/close`),
  refundSupportTicket: (id) => api.patch(`/support/${id}/refund`),
  compensateSupportTicket: (id) => api.patch(`/support/${id}/compensate`),
};
