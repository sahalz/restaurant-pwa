      ...
      <div className="auth-container" style={{
        ...
        <div className="auth-header" style={{ marginBottom: '28px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '0.95rem', margin: 0 }}>
            Register a new Staff or Manager account
          </p>
        </div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '4px' }}>
              <button
                ...
                style={{
                  ...
                  padding: '14px 10px',
                  borderRadius: '14px',
                  border: formData.role === 'staff' ? '2.5px solid #6366f1' : '1.5px solid #cbd5e1',
                  backgroundColor: formData.role === 'staff' ? 'rgba(99, 102, 241, 0.06)' : '#ffffff',
                  color: formData.role === 'staff' ? '#4f46e5' : '#64748b',
                  fontWeight: '700',
                  fontSize: '13.5px',
                  cursor: 'pointer',
                  transition: 'all 0.2s ease',
                  ...
                  alignItems: 'center',
                  gap: '8px',
                  boxShadow: formData.role === 'staff' ? '0 8px 16px rgba(99, 102, 241, 0.12)' : 'none'
                }}
              >
