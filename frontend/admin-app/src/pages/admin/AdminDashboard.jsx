              ...
              <div className="orders-panel">
                <div className="panel-header">
                  ...
                  <div className="orders-filter-bar">
                    ...
                    <button 
                      className={`order-filter-btn ${orderFilter === 'cancelled' ? 'active' : ''}`}
                                  ...
                                  <div>
                                    ...
                                    {order.delivery_instructions.voiceUrl && (
                                      <div style={{ background: '#e2e8f0', padding: '4px 8px', borderRadius: '4px', display: 'inline-flex', alignItems: 'center', gap: '6px', marginBottom: '6px', fontSize: '0.8rem' }}>
                                        🎙️ Voice Note
                                        <button type="button" style={{ background: '#475569', border: 'none', color: '#fff', borderRadius: '50%', width: '18px', height: '18px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', fontSize: '0.6rem' }} onClick={() => alert('Simulated playing voice note for dispatcher...')}>▶</button>
                                      </div>
                                    )}
